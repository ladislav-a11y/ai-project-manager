...
def test_groq_tool_call_validation_failure_is_requeued_for_retry():
    """A provider tool-schema mismatch fixed in AO must not require human triage."""
    project = _blocked(
        blocked_by=(
        ...
        checkpoint={"run_id": "keep-run", "completed_dod_indices": []},
    )
